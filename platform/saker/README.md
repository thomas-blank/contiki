...
1. In `project-conf.h`, configure `PLATFORM_CONF_USE_CC1200`. If it is set to 1, the CC2538 2.4GHz RF
core will be disabled and the CC120 will be started to drive its Sub-GHz
antenna. This configuration will work with all CC13xx based communication
partners. If it is set to 0 or not defined (the default is 0), the CC1200 will
be disabled and the CCC2538 RF Core will be enabled. This will work with all
CC26xx based devices.
